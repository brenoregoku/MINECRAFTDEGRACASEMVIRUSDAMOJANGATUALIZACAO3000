...
fabric.Image.fromURL(getImage, function(Img) {
    ...
    blockImageObject.scaleToWidth(blockImageWidht);
...
function myKeyDown(e){
    ...
    if(e.shiftKey == true && keyPressed == '80')
    {
        ...
        blockImageWidht = blockImageWidht + 10;
        blockImageHeight = blockImageHeight + 10;
        document.getElementById("currentWidth").innerHTML = blockImageWidht;
...
function left()
{
   if(playerY >0)
   {
      playerX = playerX - blockImageWidht;
      console.log("altura da imagem do bloco =" + blockImageWidht);
